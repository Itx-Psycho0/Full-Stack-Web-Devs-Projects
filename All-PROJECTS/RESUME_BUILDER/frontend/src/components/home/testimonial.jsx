...
const Testimonial = () => {
    ...
    return (
        ...
        <>
            <div id="testimonials" className="flex flex-col items-center my-20 scroll-mt-22">
                ...
                <Title title="Don't just take our word for it" description="Here what our user says about our resume builder" /></div>
